...
def render(filters: dict):
    ...
    if "Q4" in df_motor.columns and "Q39" in df_motor.columns and "RenewalYearMonth" in df_motor.columns:
        ...
        if not switchers.empty:
            ...
            fig_qc.update_layout(
                ...
                font=dict(family="Verdana, Geneva, sans-serif"), plot_bgcolor="white", paper_bgcolor="white",
            )
    ...
    fig_dist.update_layout(
        height=250, margin=dict(t=10), font=dict(family="Verdana, Geneva, sans-serif"),
    ...
    if quality_rows:
        ...
        styled = df_quality.style.apply(_style_quality, axis=1).set_properties(**{"font-family": "Verdana, Geneva, sans-serif"})
